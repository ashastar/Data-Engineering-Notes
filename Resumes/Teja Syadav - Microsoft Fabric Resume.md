...
**Email:** teja.syadav@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/teja-syadav | **Experience:** 3 years
...
### Aerospace Manufacturing Analytics
**Technology:** Microsoft Fabric, Databricks, PySpark, Azure Data Factory  
**Duration:** 15 months

- Built comprehensive aerospace manufacturing analytics platform using Microsoft Fabric
- Implemented quality control systems for aircraft component production and assembly
- Created engineering dashboards for defect analysis and production optimization
- Improved manufacturing efficiency by 40% and reduced defect rates by 55%

### Smart Home Energy Management
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 8 months

- Developed intelligent home energy management system using Microsoft Fabric
- Implemented IoT integration for smart appliances and renewable energy sources
- Built homeowner dashboards for energy consumption optimization and cost tracking
- Reduced energy costs by 35% and increased renewable energy usage by 50%

### Cybersecurity Threat Intelligence
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 11 months

- Created comprehensive cybersecurity threat intelligence platform using Microsoft Fabric
- Implemented real-time threat detection and automated response systems
- Built security operations center dashboards for threat monitoring and incident response
- Prevented 200+ potential cyber attacks and reduced response time by 70%

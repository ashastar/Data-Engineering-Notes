...
**Email:** sunad.raj@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/sunad-raj | **Experience:** 3 years
...
- Built intelligent traffic light control system using Microsoft Fabric
- Implemented real-time traffic flow optimization across 200+ intersections
- Created traffic management dashboards for city planners and emergency services
- Reduced traffic congestion by 40% and improved emergency response times by 30%

### Precision Medicine Platform
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 12 months

- Developed comprehensive precision medicine platform using Microsoft Fabric
- Implemented genomic data analysis and personalized treatment recommendations
- Built physician dashboards for patient care and treatment outcome tracking
- Improved treatment success rates by 50% and reduced adverse drug reactions by 60%

### Smart Agriculture Drones
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 9 months

- Created comprehensive drone-based agriculture analytics platform using Microsoft Fabric
- Implemented crop health monitoring and yield prediction using computer vision
- Built farmer dashboards for field management and resource optimization
- Increased crop yields by 25% and reduced water usage by 35%

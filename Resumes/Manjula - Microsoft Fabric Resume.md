...
**Email:** manjula@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/manjula | **Experience:** 3 years
...
### Deep Sea Exploration Platform
**Technology:** Microsoft Fabric, Databricks, PySpark, Azure Data Factory  
**Duration:** 16 months

- Built comprehensive deep sea exploration data platform using Microsoft Fabric
- Implemented real-time data processing from underwater vehicles and sensors
- Created research dashboards for ocean floor mapping and marine life discovery
- Enabled discovery of 5 new species and 3 underwater archaeological sites

### Smart City Air Quality
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 9 months

- Developed comprehensive air quality monitoring system using Microsoft Fabric
- Implemented real-time pollution tracking across 100+ monitoring stations
- Built citizen dashboards for health advisories and air quality predictions
- Reduced air pollution levels by 25% and improved public health outcomes

### Space Debris Tracking
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 11 months

- Created comprehensive space debris tracking platform using Microsoft Fabric
- Implemented orbital prediction models for collision avoidance
- Built mission control dashboards for satellite safety and debris management
- Prevented 50+ potential satellite collisions and improved space safety

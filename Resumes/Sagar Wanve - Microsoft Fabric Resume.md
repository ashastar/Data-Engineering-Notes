...
**Email:** sagar.wanve@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/sagar-wanve | **Experience:** 3 years
...
- Built comprehensive railway operations platform using Microsoft Fabric
- Implemented predictive maintenance for trains and track infrastructure
- Created railway operator dashboards for scheduling optimization and safety monitoring
- Improved on-time performance by 40% and reduced maintenance costs by 45%

### Precision Viticulture Platform
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 8 months

- Developed comprehensive viticulture analytics platform for wine production
- Implemented grape quality prediction and harvest timing optimization using IoT and ML
- Built vineyard manager dashboards for irrigation and pest management
- Improved wine quality scores by 30% and increased harvest yields by 25%

### Autonomous Drone Delivery
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 10 months

- Created comprehensive autonomous drone delivery platform using Microsoft Fabric
- Implemented flight path optimization and weather-based routing algorithms
- Built logistics manager dashboards for drone fleet management and delivery tracking
- Reduced delivery times by 60% and improved delivery success rates by 95%

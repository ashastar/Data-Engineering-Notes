...
**Email:** shrinivas.chavan@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/shrinivas-chavan | **Experience:** 3 years
...
- Built comprehensive quality control system for precision manufacturing
- Implemented computer vision and ML models for defect detection in real-time
- Created production manager dashboards for quality metrics and process optimization
- Reduced defect rates by 60% and improved manufacturing efficiency by 35%

### Mining Operations Analytics
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 15 months

- Developed comprehensive mining operations platform using Microsoft Fabric
- Implemented equipment monitoring and geological analysis using IoT and machine learning
- Built mine operator dashboards for safety monitoring and production optimization
- Improved mining safety by 50% and increased ore extraction efficiency by 30%

### Food Supply Chain Traceability
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 8 months

- Created comprehensive food supply chain traceability platform using Microsoft Fabric
- Implemented blockchain integration for farm-to-table tracking and quality assurance
- Built consumer-facing mobile app for food origin verification and safety alerts
- Improved food safety compliance by 70% and reduced foodborne illness incidents by 45%

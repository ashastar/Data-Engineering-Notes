...
**Email:** shubrati@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/shubrati | **Experience:** 3 years
...
- Built comprehensive smart grid analytics platform for utility companies
- Implemented demand forecasting and grid optimization algorithms using machine learning
- Created utility operator dashboards for outage management and load balancing
- Improved grid efficiency by 30% and reduced power outages by 45%

### Drug Discovery Analytics
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 16 months

- Developed comprehensive drug discovery platform for pharmaceutical research
- Implemented molecular modeling and compound screening using machine learning
- Built researcher dashboards for clinical trial design and outcome prediction
- Accelerated drug discovery process by 40% and improved success rates by 25%

### Fleet Management System
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 9 months

- Created comprehensive fleet management platform for logistics companies
- Implemented vehicle tracking, fuel optimization, and driver behavior analysis
- Built fleet manager dashboards for route planning and maintenance scheduling
- Reduced operational costs by 35% and improved delivery efficiency by 40%

...
**Email:** nikita.patil@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/nikita-patil | **Experience:** 3 years
...
### Manufacturing IoT Analytics Platform
**Technology:** Microsoft Fabric, Databricks, PySpark, Azure Data Factory  
**Duration:** 8 months

- Built real-time IoT data processing system for 500+ manufacturing sensors
- Implemented predictive maintenance models using machine learning on Databricks
- Created operational dashboards showing equipment health and production efficiency
- Reduced unplanned downtime by 40% and increased overall equipment effectiveness by 25%

### Insurance Claims Processing System
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 6 months

- Developed automated claims processing pipeline using Microsoft Fabric Data Factory
- Implemented fraud detection algorithms with 92% accuracy using machine learning
- Built self-service analytics portal for claims adjusters and underwriters
- Reduced claims processing time from 15 days to 2 days and saved $2M annually

### Smart City Traffic Management
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 10 months

- Created real-time traffic flow optimization system using Microsoft Fabric
- Integrated data from traffic cameras, sensors, and mobile apps across 50+ intersections
- Implemented dynamic traffic light control algorithms reducing congestion by 30%
- Built citizen-facing dashboards showing real-time traffic conditions and route optimization

...
**Email:** pavan.reddy@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/pavan-reddy | **Experience:** 3 years
...
- Built comprehensive Antarctic research data platform using Microsoft Fabric
- Implemented real-time environmental monitoring and climate data analysis
- Created research dashboards for ice sheet monitoring and wildlife tracking
- Contributed to 10+ climate research papers and international climate reports

### Smart Port Operations
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 10 months

- Developed comprehensive port operations platform using Microsoft Fabric
- Implemented container tracking and logistics optimization algorithms
- Built port authority dashboards for traffic management and security monitoring
- Improved port efficiency by 35% and reduced cargo handling time by 40%

### Virtual Reality Therapy
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 7 months

- Created comprehensive VR therapy analytics platform using Microsoft Fabric
- Implemented patient progress tracking and treatment effectiveness analysis
- Built therapist dashboards for session monitoring and outcome prediction
- Improved patient recovery rates by 45% and reduced treatment duration by 30%

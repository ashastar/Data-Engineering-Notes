...
**Email:** shubham.sarade@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/shubham-sarade | **Experience:** 3 years
...
### Agricultural IoT Data Platform
**Technology:** Microsoft Fabric, Databricks, PySpark, Azure Data Factory  
**Duration:** 9 months

- Built comprehensive IoT data platform for precision agriculture across 1000+ farms
- Implemented crop yield prediction models using satellite imagery and weather data
- Created farmer-facing mobile dashboards for real-time field monitoring and alerts
- Increased crop yields by 20% and reduced water usage by 30% through data-driven insights

### Real Estate Market Analytics
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 6 months

- Developed comprehensive real estate market analysis platform using Microsoft Fabric
- Implemented property valuation models using machine learning and market trends
- Built investment opportunity dashboards for real estate investors and agents
- Processed 5M+ property records and provided 95% accurate market predictions

### Logistics Route Optimization
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 8 months

- Created intelligent route optimization system for last-mile delivery operations
- Integrated real-time traffic, weather, and delivery data across 50+ cities
- Implemented dynamic routing algorithms reducing delivery time by 25% and fuel costs by 20%
- Built driver mobile app with real-time route updates and delivery tracking

...
**Email:** krishnamurthi.g@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/krishnamurthi-g | **Experience:** 3 years
...
- Built real-time energy grid monitoring system processing 1TB+ data daily
- Implemented predictive analytics for power outage prevention using machine learning
- Created emergency response dashboards for grid operators and maintenance teams
- Reduced power outages by 60% and improved grid reliability by 35%

### Retail Inventory Optimization Platform
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 7 months

- Developed AI-powered inventory management system for 200+ retail stores
- Implemented demand forecasting models using time series analysis on Databricks
- Built automated reorder systems reducing stockouts by 45% and overstock by 30%
- Created real-time inventory dashboards for store managers and supply chain teams

### Social Media Sentiment Analytics
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 5 months

- Built real-time social media sentiment analysis platform using Microsoft Fabric
- Processed 10M+ social media posts daily across multiple platforms and languages
- Implemented brand monitoring dashboards for marketing teams and executives
- Provided actionable insights that improved brand sentiment by 25% and engagement by 40%

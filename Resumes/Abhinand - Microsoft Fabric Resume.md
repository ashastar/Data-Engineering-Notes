...
**Email:** abhinand@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/abhinand | **Experience:** 3 years
...
### Autonomous Vehicle Data Platform
**Technology:** Microsoft Fabric, Databricks, PySpark, Azure Data Factory  
**Duration:** 14 months

- Built comprehensive data platform for autonomous vehicle fleet management
- Implemented real-time sensor data processing from 1000+ vehicles across multiple cities
- Created safety monitoring dashboards with predictive maintenance and incident analysis
- Achieved 99.9% uptime and reduced maintenance costs by 45% through predictive analytics

### Food Safety Monitoring System
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 9 months

- Developed end-to-end food safety monitoring platform for restaurant chains
- Implemented temperature and humidity tracking across 500+ locations with real-time alerts
- Built compliance dashboards for health inspectors and food safety managers
- Reduced food safety incidents by 60% and improved compliance scores by 40%

### Digital Marketing Attribution Platform
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 7 months

- Created comprehensive marketing attribution platform using Microsoft Fabric
- Implemented multi-touch attribution models across 20+ marketing channels
- Built ROI optimization dashboards for marketing teams and executives
- Improved marketing ROI by 50% and reduced customer acquisition costs by 30%

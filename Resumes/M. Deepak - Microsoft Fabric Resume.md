...
**Email:** deepak.m@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/deepak-m | **Experience:** 3 years
...
- Built comprehensive nuclear power plant monitoring system using Microsoft Fabric
- Implemented real-time radiation monitoring and safety system integration
- Created control room dashboards for reactor performance and safety compliance
- Achieved 100% safety compliance and zero incidents over 2-year operational period

### Virtual Reality Training Platform
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 9 months

- Developed VR training analytics platform for industrial safety training
- Implemented performance tracking and skill assessment using machine learning
- Built instructor dashboards for training effectiveness and learner progress
- Improved training completion rates by 50% and reduced workplace accidents by 60%

### Gene Therapy Research Analytics
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 13 months

- Created comprehensive gene therapy research data platform using Microsoft Fabric
- Implemented genomic data analysis and treatment outcome prediction models
- Built researcher dashboards for clinical trial monitoring and patient tracking
- Contributed to successful FDA approval of 3 new gene therapy treatments

...
**Email:** iswarya@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/iswarya | **Experience:** 3 years
...
- Built intelligent waste management system for smart city with 2M+ residents
- Implemented IoT sensor networks for bin fill-level monitoring and route optimization
- Created municipal dashboards for waste collection scheduling and environmental impact tracking
- Reduced collection costs by 30% and improved recycling rates by 40%

### Fashion Trend Prediction Platform
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 7 months

- Developed AI-powered fashion trend prediction platform using Microsoft Fabric
- Implemented computer vision models analyzing social media and runway data
- Built designer dashboards for trend forecasting and inventory planning
- Improved fashion brand sales by 35% and reduced overstock by 50%

### Mental Health Analytics
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 8 months

- Created comprehensive mental health analytics platform for healthcare providers
- Implemented sentiment analysis and behavioral pattern recognition using machine learning
- Built therapist dashboards for patient progress tracking and treatment optimization
- Improved patient outcomes by 45% and reduced treatment duration by 25%

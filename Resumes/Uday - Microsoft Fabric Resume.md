...
**Email:** uday@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/uday | **Experience:** 3 years
...
- Built comprehensive Formula 1 racing analytics platform using Microsoft Fabric
- Implemented real-time telemetry data processing from race cars during live events
- Created pit crew dashboards for strategy optimization and performance monitoring
- Contributed to 3 race wins and 2 championship titles through data-driven insights

### Smart Hospital Management
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 10 months

- Developed comprehensive hospital management system using Microsoft Fabric
- Implemented patient flow optimization and resource allocation algorithms
- Built administrative dashboards for capacity planning and operational efficiency
- Reduced patient wait times by 45% and improved bed utilization by 30%

### Blockchain Analytics Platform
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 9 months

- Created comprehensive blockchain analytics platform using Microsoft Fabric
- Implemented transaction pattern analysis and fraud detection for cryptocurrency
- Built investor dashboards for market analysis and portfolio optimization
- Processed 1B+ blockchain transactions and identified 500+ suspicious activities

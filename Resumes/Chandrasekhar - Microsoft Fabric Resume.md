...
**Email:** chandrasekhar@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/chandrasekhar | **Experience:** 3 years
...
- Built comprehensive smart building IoT platform for 50+ commercial buildings
- Implemented energy optimization algorithms reducing consumption by 35%
- Created facility management dashboards for maintenance scheduling and space utilization
- Integrated HVAC, lighting, and security systems with real-time monitoring and control

### Cryptocurrency Trading Analytics
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 8 months

- Developed high-frequency cryptocurrency trading analytics platform using Microsoft Fabric
- Implemented real-time market analysis and trading signal generation algorithms
- Built risk management dashboards with automated position sizing and stop-loss systems
- Processed 500M+ transactions daily across 100+ cryptocurrency exchanges

### Educational Learning Analytics
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 6 months

- Created comprehensive learning analytics platform for online education platform
- Implemented student performance prediction models using machine learning
- Built instructor dashboards for course optimization and student engagement tracking
- Improved student completion rates by 40% and course satisfaction scores by 30%

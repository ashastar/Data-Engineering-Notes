...
**Email:** gulipalli.prasad@email.com | **Phone:** +91-XXXXXXXXXX | **Location:** India  
**LinkedIn:** linkedin.com/in/gulipalli-prasad | **Experience:** 3 years
...
- Built HIPAA-compliant telemedicine data platform processing patient consultations
- Implemented AI-powered diagnostic assistance using medical imaging and patient data
- Created real-time patient monitoring dashboards for healthcare providers
- Improved diagnostic accuracy by 30% and reduced consultation time by 40%

### Sports Performance Analytics
**Technology:** Microsoft Fabric, Azure Synapse, Python, Power BI  
**Duration:** 7 months

- Developed comprehensive sports analytics platform for professional football team
- Implemented player performance tracking using IoT sensors and video analysis
- Built coaching dashboards for tactical analysis and injury prevention
- Improved team performance metrics by 25% and reduced injury rates by 35%

### Environmental Monitoring System
**Technology:** Microsoft Fabric, Delta Lake, SQL, Power BI  
**Duration:** 6 months

- Created real-time environmental monitoring system for air and water quality
- Integrated data from 200+ sensors across urban areas and industrial zones
- Implemented pollution prediction models and automated alert systems
- Built public-facing dashboards for environmental awareness and health advisories
